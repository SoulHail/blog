...
<div class="main-container" id="main-container">
                                ...
                                <div class="widget-main no-padding ">
                                    <div class="widget-main ">
                                        <form class="form-inline form-horizontal"
                                              action="${ctx}/mpos/updateUserFee/list" id="searchForm"
                                              method="post">
                                            ...
                                            <button class="btn btn-info btn-sm" type="button" onclick="editFee()">
                                                <span class="ace-icon fa fa-refresh icon-on-right bigger-110"></span>修改
                                            </button>
                                            <button class="btn btn-info btn-sm" type="button" onclick="batchEditFee()">
    ...
    <script type="text/javascript">
        ...
        function sub() {
            ...
            window.location.href='${ctx}/mpos/updateUserFee/list?inMno='+inMno+'&startTime='+startTime+'&endTime='+endTime+'&rateId='+rateId+'&updateSource='+updateSource;
        }

        // 批量修改费率
        function batchEditInfo() {
            $.fancybox.open({
                href: '${ctx}/mpos/updateUserFee/batchEdit',
                type: 'iframe',
                scrolling: 'no',
                scrollOutside: false,
                model: true,
        ...
        function editFee() {
            $.fancybox.open({
                href: '${ctx}/mpos/updateUserFee/edit?',
                type: 'iframe',
                padding: 5,
                scrolling: 'no',
                fitToView: true,
