                                ...
                                <div class="widget-main no-padding ">
                                    <div class="widget-main ">
                                        ...
                                        <form class="form-inline form-horizontal"
                                              action="${ctx}/mpos/advties/add" id="searchForm"
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding" style="width: 150px">
                                                        <select data-placeholder="请选择" name="page" id="page" class="chosen-select form-control " style="width: 150px">
                                                            <option value="page_h5_0001" >签购单</option>
                                                            <option value="page_app_0001" >启屏页</option>
                                                            <option value="page_app_0002" >首页</option>
                                                            <option value="page_app_0003" >交易成功页面</option>
                                                            <option value="page_app_0004" >交易失败页面</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group form-group-sm width-300px">
                                            ...
                                            <div class="col-xs-12">
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding">
                                                        <input class="form-control input-small width-200px view-control" name="iconUrl" id="iconUrl">
                                                    </div>
                                                </div>
                                                <div class="form-group form-group-sm width-300px">
                                                    <label for="form-field-6" class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left">广告链接地址</label>
                                                    <div class="col-sm-8  no-padding">
                                                        <input class="form-control input-small width-200px view-control" name="adUrl" id="adUrl">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding">
                                                        <input class="form-control input-small width-200px view-control" name="nativePageName" id="nativePageName">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding" style="width: 150px">
                                                        <select data-placeholder="请选择" name="businessVerify" id="businessVerify" class="chosen-select form-control " style="width: 150px">
                                                            <option value="" selected>请选择</option>
                                                            <option value="01" >绑卡</option>
                                                            <option value="02" >绑设备</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group form-group-sm width-300px">
