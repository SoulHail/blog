                        ...
                        <div class="widget-box widget-color-normal3" style="opacity: 1;">
                            <div class="widget-header">
                                <h5 class="widget-title bigger lighter">
                                    <i class="ace-icon fa fa-table"></i> 添加关卡配置
                                </h5>
                                        ...
                                        <form class="form-inline form-horizontal"
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding">
                                                        <input class="form-control input-small width-200px view-control" name="pointName" id="pointName">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding">
                                                        <input class="form-control input-small width-200px view-control" name="pointLevel" id="pointLevel">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding">
                                                        <input class="form-control input-small width-200px view-control" name="pointNum" id="pointNum">
                                                    </div>
                                                </div>
