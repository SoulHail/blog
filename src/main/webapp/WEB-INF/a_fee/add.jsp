                        ...
                        <div class="widget-box widget-color-normal3" style="opacity: 1;">
                            <div class="widget-header">
                                <h5 class="widget-title bigger lighter">
                                    <i class="ace-icon fa fa-table"></i> 添加费率套餐配置
                                </h5>
                                        ...
                                        <form class="form-inline form-horizontal"
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding">
                                                        <input class="form-control input-small width-200px view-control" name="feeCode" id="feeCode">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding">
                                                        <input class="form-control input-small width-200px view-control" name="feeName" id="feeName">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding">
                                                        <input class="form-control input-small width-200px view-control" name="feeDesc" id="feeDesc">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding">
                                                        <input class="form-control input-small width-200px view-control" name="debitRate" id="debitRate">
                                                        <span style="color: red">*字符长度最大为4*</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding">
                                                        <input class="form-control input-small width-200px view-control" name="creditRate" id="creditRate">
                                                        <span style="color: red">*字符长度最大为4*</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding">
                                                        <input class="form-control input-small width-200px view-control" name="settleFee" id="settleFee">
                                                        <span style="color: red">*字符长度最大为4*</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding">
                                                        <input class="form-control input-small width-200px view-control" name="duration" id="duration">
                                                        <span style="color: red">*9999表长期*</span>
                                                    </div>
                                                </div>
