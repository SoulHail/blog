                                        ...
                                        <form class="form-inline form-horizontal"
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <input class="form-control input-small width-148px view-control" style="width: 148px" name="couponId" id="couponId">
                                                </div>
                                                ...
                                                <div class="form-group form-group-sm width-400px">
                                                    ...
                                                    <select data-placeholder="请选择" name="taskCondition" id="taskCondition" class="chosen-select form-control " style="width: 130px">
                                                        ...
                                                        <option value="4" >开通VIP</option>
                                                        <option value="5" >完成信用卡绑定X张</option>
                                                        <option value="6" >月云闪付X笔累计交易Y元</option>
                                                        <option value="7" >累计拉新X人</option>
                                                    </select>
