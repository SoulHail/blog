                                        ...
                                        <form class="form-inline form-horizontal"
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <select data-placeholder="请选择" name="taskModul" id="taskModul" class="chosen-select form-control " style="width: 150px">
                                                        <option value="" <%="".equals(task)?"selected":"" %> >请选择</option>
                                                        <option value="1" <%="1".equals(task)?"selected":"" %> >每日福利</option>
                                                        <option value="2" <%="2".equals(task)?"selected":"" %> >自选有礼</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding">
                                                        <input class="form-control input-small width-200px view-control" name="taskName" id="taskName" value="${newHandDomain.taskName}">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <select data-placeholder="请选择" name="couponType" id="couponType" class="chosen-select form-control " style="width: 98px">
                                                        <option value="1" <%="1".equals(couponType)?"selected":"" %> >优惠券ID</option>
                                                        <option value="2" <%="2".equals(couponType)?"selected":"" %> >券包ID</option>
                                                    </select>
                                                    <input class="form-control input-small width-148px view-control" style="width: 148px" name="couponId" id="couponId" value="${newHandDomain.taskName}">
                                                </div>

                                                <div class="form-group form-group-sm width-400px">
                                                    <label for="form-field-6" class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left">任务条件</label>
                                                    <%String taskCondition = (String) session.getAttribute("taskCondition"); %>
                                                    <select data-placeholder="请选择" name="taskCondition" id="taskCondition" class="chosen-select form-control " style="width: 130px">
                                                        <option value="" <%="".equals(taskCondition)?"selected":"" %> >请选择</option>
                                                        <option value="1" <%="1".equals(taskCondition)?"selected":"" %> >首笔交易</option>
                                                        <option value="2" <%="2".equals(taskCondition)?"selected":"" %> >观看视频</option>
                                                        <option value="3" <%="3".equals(taskCondition)?"selected":"" %> >银联二维码交易X笔累计交易X元</option>
                                                        <option value="4" <%="4".equals(taskCondition)?"selected":"" %> >开通VIP</option>
                                                        <option value="5" <%="5".equals(taskCondition)?"selected":"" %> >完成信用卡绑定X张</option>
                                                        <option value="6" <%="6".equals(taskCondition)?"selected":"" %> >月云闪付X笔累计交易Y元</option>
                                                        <option value="7" <%="7".equals(taskCondition)?"selected":"" %> >累计拉新X人</option>
                                                    </select>
                                                    <input class="form-control input-small width-50px view-control" style="width: 50px" name="count" id="count">张/笔/人
                                                    <input class="form-control input-small width-50px view-control" style="width: 50px" name="money" id="money">K
                                                </div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    <label for="form-field-6" class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left">跳转类型</label>
                                                    <%String jumpType = (String) session.getAttribute("jumpType"); %>
                                                    <div class="col-sm-8  no-padding">
                                                        <input name="jumpType" type="radio" <%="1".equals(jumpType)?"checked":"" %> value="1"/>本地
                                                        <input name="jumpType" type="radio" <%="2".equals(jumpType)?"checked":"" %> value="2"/>h5
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding">
                                                        <input class="form-control input-small width-200px view-control" name="jumpUrl" id="jumpUrl" value="${newHandDomain.jumpUrl}">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding" style="width: 150px">
                                                        <%String loopType = (String) session.getAttribute("loopType"); %>
                                                        <select data-placeholder="请选择" name="loopType" id="loopType" class="chosen-select form-control " style="width: 150px">
                                                            <option value="" <%="".equals(loopType)?"selected":"" %> >请选择</option>
                                                            <option value="1" <%="1".equals(loopType)?"selected":"" %> >一次性任务</option>
                                                        </select>
                                                    </div>
                                                </div>

                                                <div class="form-group form-group-sm width-300px">
                                                    <label for="form-field-6" class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left">展示进度</label>
                                                    <div class="col-sm-8  no-padding">
                                                        <%String progress = (String) session.getAttribute("progress"); %>
                                                        <input name="progress" type="radio" value="1" <%="1".equals(progress)?"checked":"" %> />是
                                                        <input name="progress" type="radio" value="2" <%="2".equals(progress)?"checked":"" %> />否
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row" style="margin-top: 10px;">
                                                <div class="col-md-12 col-sm-12 form-group-sm">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <input type="button" class="form-control input-small width-100px" onclick="uploadLogoclick();" value="上传logo"/>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding">
                                                        <textarea class="form-control input-small width-200px view-control" name="awrdDescribe" id="awrdDescribe" placeholder="${newHandDomain.awrdDescribe}"></textarea>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding">
                                                        <textarea class="form-control input-small width-200px view-control" name="taskDescribe" id="taskDescribe" placeholder="${newHandDomain.taskDescribe}"></textarea>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding">
                                                        <textarea class="form-control input-small width-200px view-control" name="taskPopupDescribe" id="taskPopupDescribe" placeholder="${newHandDomain.taskPopupDescribe}"></textarea>
                                                    </div>
                                                </div>
    ...
    function sub(){
        $.ajax({
            ...
            data : {
                ...
                taskCondition : $("#taskCondition").val(),
                taskPic : $("#taskPic").val(),
                awrdDescribe : $("#awrdDescribe").val(),
                jumpType : $('input[name="jumpType"]:checked').val(),
                jumpUrl : $("#jumpUrl").val(),
                ...
                taskPopupDescribe : $("#taskPopupDescribe").val(),
