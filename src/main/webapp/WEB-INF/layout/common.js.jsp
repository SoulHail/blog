...
<script src="<%=request.getContextPath() %>/js/ueditor/ueditor.config.js"></script>
<script src="<%=request.getContextPath() %>/js/ueditor/ueditor.all.js"></script>
<%-- <script src="<%=request.getContextPath() %>/js/ueditor/ueditor.all.min.js"></script> --%>
<script src="<%=request.getContextPath() %>/js/ueditor/ueditor.parse.js"></script>
<%-- <script src="<%=request.getContextPath() %>/js/ueditor/ueditor.parse.min.js"></script> --%>
...
<%-- 
<script type="text/javascript" src="<%=request.getContextPath() %>/js/multiSelect/js/bootstrap-multiselect.js"></script> --%>
<script type="text/javascript" src="<%=request.getContextPath() %>/js/jquery.sumoselect.min.js"></script>
