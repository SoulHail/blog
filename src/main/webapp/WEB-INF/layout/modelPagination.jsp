...
<div id="pagination" class="dataTables_paginate paging_simple_numbers clearfix"  >
...
//    linkTagAttrs.params = linkParams
    ...
    var firststep	= 1
    var laststep	= Math.round(Math.ceil(total / max))
...
//        linkTagAttrs.class = 'step'
        ...
        if (beginstep > firststep) {
            linkParams.offset = 0;
            str += "<li> <a href='#'  onclick='page("+firststep+ ")'>";
            str +=  firststep;
            str += "</a></li>";
        ...
        for (var x = beginstep; x <= endstep ;x++){
            if (currentstep == x) {
                str+= "<li class='active'><a href='#'  onclick='page("+x+ ")'>"+x+"</a></li>"
            }
            else {
//                linkParams.offset = (i - 1) * max
                str+= "<li> <a href='#'  onclick='page("+x+ ")'>";
                str+=x;
                str+="</a> </li>";
            }
        }
        ...
        if (endstep < laststep) {
            ...
            str+= '<li class="disabled"><a href="#">…</a></li>';
            str+= "<li> <a href='#' onclick='page("+laststep+ ")'>";
            str+= laststep;
            str+= "</a></li>";
        }
    }
...
//    }
    str+= "<a href='#' onclick='page("+laststep+ ")'>尾页</a>";
    str+= "</li>";
    str+= "</ul>";
    ...
    function page(currentPage){
        $("#bnkLinkForm input[name='pageNum']").val(currentPage);
        searchBnkLink();
        return true ;
    }
</script>