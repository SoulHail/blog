...
//                linkParams.offset = (i - 1) * max
    ...
    str += '<input type="number" min="1" class="form-control p" style="height:31px;width:50px">'
    ...
    str += '<select id="_pSize"  class=" form-control " style="width:60px ;height:25px;padding: 1px 3px;" onchange="onChange4PageSize(this)">';
    ...
    str += '</div>';
    if (pages > 0)
        document.getElementById("dynamic-table_info").parentNode.innerHTML = ("<div class='inline'>记录数:" + (offset + 1) + "-" + (offset + max) + " of " + total + " 共:" + pages + "页。页数</div>" + str);
    else
