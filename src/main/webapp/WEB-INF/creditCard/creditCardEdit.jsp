										...
										<div class="widget-main ">
											<form id="form" class="form-inline form-horizontal">
															...
															<div class="tab-pane active no-padding" id="home4">
																<div class="col-sm-12">
																	...
																	<div class="col-sm-16">
			                                                           ...
			                                                           <input type="text" class="form-control input-small width-200px view-control" id="appFileName" name="appFileName" readonly="readonly"  value="${creditCard.imgUrl } data-placement="bottom" data-trigger="hover"  data-rel="popover"></input>
			                                                           <input type="hidden" name="imgUrl" id="imgUrl" value="${creditCard.imgUrl }"/>
			                                                           <img alt="图片预览" src="${ctx}/creditCard/getPic?fileName=${creditCard.imgUrl }" id="pic" height="32" width="150">
			                                                          </div>
			                                                   		</div>
																	<br>
												...
												<div style="text-align: center;">
												 	<button class="btn btn-info btn-sm" type="button" name="submit-save" onclick="finalCheck('update')">
...
<script type="text/javascript">
	...
	function sub(type){
		 $.ajax({    
               type:'post',       
               url:'${ctx}/creditCard/updateCreditCard',
               cache:false,
               async:false,
               dataType: 'TEXT',
               data : {
               ...
               success:function(result){
               	 if(result==1){
               		var info_msg = type=="update"?"保存成功。":"发布成功。";
               		Modal.alert({
               			msg:info_msg
               		}).on(function(e){
               			if(e==true){
	...
	function release(){
    	var url="${ctx}/creditCard/release?uuid="+$("#uuid").val();
