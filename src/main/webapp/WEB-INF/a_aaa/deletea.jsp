                        ...
                        <div class="widget-box widget-color-normal3" style="opacity: 1;">
                            <div class="widget-header">
                                <h5 class="widget-title bigger lighter">
                                    <i class="ace-icon fa fa-table"></i>批量清除
                                    <%-- ****************************************************标题***************************************************************************** --%>
                                </h5>
                            </div>
                                ...
                                <div class="widget-main no-padding ">
                                    <div class="widget-main " style = "padding-top: 0px">
                                        ...
                                        <form class="form-inline form-horizontal no-padding"
                                              role="form" method="post" action="${ctx}/mpos/optionalBlack/deleteListSave"
                                                    ...
                                                    <div class="tab-content ">
                                                        <div class="tab-pane active no-padding" id="home4">
                                                            <div class="col-sm-12" >
                                                                ...
                                                                <div class="form-group form-group-sm width-100 ">
                                                                    <label class="col-sm-4 control-label widget-color-normal5 width-140px no-padding-left">操作来源</label>
    ...
    function checkFile(){
        ...
        $("#rateAdd").ajaxSubmit({
            ...
            success:function(obj){
                if(obj.success =='1') {
                    if (obj.error == 'Y') {
                        Modal.alert({msg: '清除成功'}).on(function(e){
                            Modal.confirm({
                                msg : "要导出清除结果吗？",
                                title : '提示',
                                btnok : '确定',
                                ...
                                if(e==true){
                                    window.location.href='${ctx}/mpos/optionalBlack/export';
